...
export const PERFORMANCE_HEADERS:readonly string[]=["Successful Orders", "Gross Sales", "Online Sales", "Cash Sales", "Delivery Sales", "Pickup Sales", "Orders count", "Cancelled Orders", "Online Orders", "Cash Orders", "Delivery Orders", "Pickup Orders", "Pro Orders", "Pro Revenue", "Items count", "Unavailable time duration (Minutes)", "Unavailable Time Duration Rate", "Scheduled Open Time (Minutes)", "Unavailable time reason", "Unavailable Time Duration count", "Orders with Avoidable cancellations", "Avoidable cancellation rate", "Revenue loss from rejections", "Avoidable Cancellation Reason", "Avoidable cancellation count", "Sales loss", "Average preparation time (minutes)", "Orders marked as ready", "Orders marked rate", "Total AWT Duration (Minutes)", "Orders with AWT", "Order with AWT Fee", "Total Fee applied", "Orders in Bucket1: < 5 minutes", "Orders with fees in Bucket1: < 5 minutes", "Orders in Bucket2: >= 5 Mins and < 10 Mins", "Orders with fees in Bucket2: >= 5 Mins and < 10 Mins", "Orders in Bucket3: >= 10 Mins", "Orders with fees in Bucket3: >= 10 Mins", "Total customer complaints received", "Customer Complaint rate", "Customer Complaint Reason", "Customer Complaint Contacts", "Own delivery contacts count", "Vendor delivery contacts counts", "Orders from new customers", "Orders from new customers rate", "Orders from returning customers", "Orders from returning customers rate", "Impressions", "Viewed your menu", "Added items to cart", "Placed an order"];
